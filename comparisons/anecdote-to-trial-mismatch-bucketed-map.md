...
This page is the decision layer downstream from [[anecdote-led-chemical-heat-map]]. The heat map asks which chemicals keep showing up in community discussion; this page asks which of those signals survive a transportability check against controlled human evidence, safety, and supply-chain reality.

The short version:

- A loud community signal does not mean a broadly useful cognition enhancer.
- Some compounds are really state-rescue tools, not baseline enhancers.
- Some are confounded by sourcing, gray-market identity, or class heterogeneity.
- A few are still worth replication because they have one clean human signal and no better explanation yet.

What changed since 2024:

- WADA's 2025 Prohibited List still explicitly names `Fonturacetam [4-phenylpiracetam (carphedon)]` and `Bromantan`, which means the phenylpiracetam / bromantane lane is now clearly entangled with sports visibility, not just nootropic lore.^[https://www.wada-ama.org/en/prohibited-list]
- Methylene blue now has a posted results record on ClinicalTrials.gov, but this sweep still did not find a peer-reviewed full results paper or accessible numeric tables, so the branch remains narrow rather than upgraded.^[raw/articles/clinicaltrials-nct02380573-methylene-blue-results-posted.md]
- Tianeptine and phenibut remain risk-first because abuse, dependence, adulteration, and withdrawal are not side issues; they are the main interpretation problem.^[raw/articles/pubmed-37453966-tianeptine-abuse-review.md]^[raw/articles/pubmed-23391959-phenibut-dependence.md]
- NSI-189 and 9-Me-BC still look like translational or preclinical hypotheses, not healthy-adult cognition branches.^[https://pubmed.ncbi.nlm.nih.gov/27528461/]^[https://pubmed.ncbi.nlm.nih.gov/32285253/]
...
- `replication-worthy`: a single controlled human signal is credible enough that repeating it in the same phenotype would answer a real question.
- `state-bound`: the apparent benefit is tied to sleep loss, fatigue, exposure therapy, depression, or another rescue context, not broad baseline enhancement.
...
1. [Troof nootropic ratings analysis](https://troof.blog/posts/nootropics/) - structured community ratings dataset, 2,802 people and 36,163 ratings.
2. [Astral Codex Ten 2020 nootropics survey](https://www.astralcodexten.com/p/nootropics-survey-2020-results) - 852 respondents and a second open-label community signal.
3. [WADA 2025 Prohibited List](https://www.wada-ama.org/en/prohibited-list) - sports-visibility signal for phenylpiracetam and bromantane.
4. [PRL-8-53 human trial](https://pubmed.ncbi.nlm.nih.gov/418433/) - single double-blind human learning / retention study.
5. [Bromantane human volunteers](https://pubmed.ncbi.nlm.nih.gov/10998997/) - small healthy-volunteer psychophysiology study.
6. [NSI-189 phase 1b / 2 depression trial](https://pubmed.ncbi.nlm.nih.gov/27528461/) - depression study with some cognitive subtests but no broad enhancer proof.
7. [9-Me-BC astrocyte / neurotrophic study](https://pubmed.ncbi.nlm.nih.gov/32285253/) - preclinical mechanism, no human cognition bridge in this sweep.
8. [Noopept foundational review](https://pubmed.ncbi.nlm.nih.gov/12596521/) and [HIF-1 mechanistic paper](https://pubmed.ncbi.nlm.nih.gov/33119829/) - noopept remains mechanism-heavy and human-light.
9. [Tianeptine abuse review](https://pubmed.ncbi.nlm.nih.gov/37453966/) - current abuse / dependence framing.
10. [Phenibut dependence case report](https://pubmed.ncbi.nlm.nih.gov/23391959/) - dependence and withdrawal dominate interpretation.
11. [Selegiline early-PD cognition trial](raw/articles/pubmed-8665548-selegiline-cognition-early-pd.md) - short-term disease-context rescue signal.
12. [Selegiline Alzheimer's meta-analysis](raw/articles/pubmed-11813282-selegiline-alzheimers-meta-analysis.md) - short-term AD cognition signal that disappears later.
13. [Noopept rat memory-blockade study](raw/articles/pubmed-19145351-noopept-rat-memory-blockade.md) - preclinical antiamnesic anchor.
14. [Classic psychedelic microdosing comparison](classic-psychedelic-microdosing-vs-psychoplastogens.md) - formal microdosing counterweight plus anecdote-routing layer.

## Anecdote Ledger

| Source | Source type | Exact source | Date checked | Signal size | Signal strength | Direction | Context | Caveat |
|---|---|---|---|---|---|---|---|---|
| Troof nootropics analysis | Structured community survey / recommender analysis | https://troof.blog/posts/nootropics/ | 2026-04-28 | 2,802 people / 36,163 ratings | Very-high | Positive for phenylpiracetam, methylene blue, study-stack chemicals, and several risk-prone compounds | Open-label self-report across many compounds | Self-selected, unblinded, expectation-heavy, not causal |
| Astral Codex Ten 2020 survey | Structured community survey | https://www.astralcodexten.com/p/nootropics-survey-2020-results | 2026-04-28 | 852 respondents | Strong | Positive for common stimulants and a few rarer substances, including strong interest in tianeptine / phenibut | Open-label survey | No randomization, no product QA, no separation of mood vs cognition |
| Classic psychedelic microdosing productivity threads | Reddit / forum anecdote cluster | `raw/articles/reddit-2022-2026-psychedelic-microdosing-productivity-threads.md`; primary URL: https://www.reddit.com/r/NooTopics/comments/1t9zehn/the_myth_of_microdosing_psychedelics_for/ | 2026-05-12 | 6+ checked threads / visible debate | Strong for salience | Mixed: productivity, creativity, clarity, flow, and anxiety-relief claims plus null or worse-focus counterreports | Healthy/productivity-oriented psilocybin, mushroom, truffle, or LSD microdosing | Self-selection, expectancy, dose/substance ambiguity, legal/sourcing risk, and controlled-evidence mismatch |
| Noopept | anecdote | Reddit /r/Nootropics thread on 2023-05-14 plus follow-on racetam chatter | thread-level with many replies; `moderate` | Focus, mood, brain fog, memory, and work stamina | low | Route and product identity alter the signal as much as the molecule name |
| Selegiline | anecdote | Reddit /r/Nootropics thread on 2023-03-23 plus repeated deprenyl chatter | multiple replies; `moderate` | Energy, clarity, dopamine support, and rescue framing | low | MAOI interactions and washout rules keep the branch prescription-bound |

## Mismatch Matrix

| Compound | Why the community likes it | Controlled evidence / transportability | Main mismatch driver | Bucket |
|---|---|---|---|---|
| Phenylpiracetam | Study-stack, motivation, cold-resistance, and stimulant-adjacent performance lore. | Old regional literature exists, but the modern healthy-adult cognition bridge is thin and WADA visibility is now explicit.^[https://www.wada-ama.org/en/prohibited-list] | Acute actoprotection gets read as broad enhancement. | `state-bound` |
...
| Selegiline / MAO-B claims | Drive, energy, and "microdose" chatter that sounds like clean enhancement. | Early PD and AD meta-analytic data show a short-lived cognition bridge, but the effect is not durable or clinically meaningful and remains prescription-bound.^[raw/articles/pubmed-8665548-selegiline-cognition-early-pd.md]^[raw/articles/pubmed-11813282-selegiline-alzheimers-meta-analysis.md] | Rescue effects and withdrawal / activation effects get collapsed into "cognition". | `state-bound` |
| Methylene blue | Energy, focus, and memory anecdote, plus a reputation for being more "real" than most nootropics. | Small human imaging and exposure-therapy studies show a narrow but real memory / consolidation signal.^[raw/articles/pubmed-27351678-methylene-blue-human-brain-fmri.md]^[raw/articles/pubmed-26961091-methylene-blue-functional-connectivity-human-brain.md]^[raw/articles/pubmed-28686823-methylene-blue-ptsd-exposure-rct.md] | Session-dependent consolidation adjunct, not a universal enhancer. | `state-bound` |
| Tianeptine | Strong subjective reports that often feel like clear thinking or motivation. | Abuse, dependence, and withdrawal literature now dominate the practical interpretation.^[raw/articles/pubmed-37453966-tianeptine-abuse-review.md]^[raw/articles/pubmed-23391959-phenibut-dependence.md] | Euphoria or withdrawal relief masquerades as function. | `risk-first` |
| Phenibut | Anxiety, sociability, and sleep-adjacent benefits are highly salient to users. | Dependence and withdrawal are common enough that they define the branch more than cognition does.^[raw/articles/pubmed-23391959-phenibut-dependence.md] | Anxiolysis and withdrawal reversal masquerade as enhancement. | `risk-first` |

## Evidence Tiering

- Structured community signal: Troof and the ACX survey are useful for search-space reduction, not efficacy.
...
- PRL-8-53: unknown; the human signal is too sparse to enrich responders confidently.
- Methylene blue: best fit is post-learning or post-exposure consolidation, especially when the training or exposure session succeeds.
...
- PRL-8-53: the original human study used low oral doses, later review pages keep repeating a 5 mg claim, and the branch still has no modern protocol standard yet.^[raw/articles/pubmed-418433-prl-8-53-human-trial.md]^[raw/articles/prl-8-53-braintropic-review.md]
- Bromantane: the healthy-volunteer literature is small and protocol-specific, not a mature dosing literature.^[raw/articles/pubmed-10998997-bromantane-human-volunteers.md]

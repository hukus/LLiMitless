...
# Sleep Banking and Sleep Extension

Sleep banking means deliberately sleeping longer before an expected period of sleep loss. Sleep extension is the broader strategy of increasing sleep opportunity to improve near-term functioning. In this wiki, both are best treated as performance-preservation tactics rather than proven cognitive enhancers.^[raw/articles/pubmed-41892386-sleep-banking-cognitive-motor-impairments-sleep-restriction.md]^[raw/articles/pubmed-40984126-sleep-extension-cognitive-performance-military-aged-adults.md]

Relevant raw PubMed notes: `raw/articles/pubmed-41892386-sleep-banking-cognitive-motor-impairments-sleep-restriction.md|sleep banking review` and `raw/articles/pubmed-40984126-sleep-extension-cognitive-performance-military-aged-adults.md|sleep extension review`.

The main signal is acute: better vigilance, reaction time, and resistance to later sleep restriction. The literature does not yet show durable disease-prevention or true nootropic effects, so the most defensible framing is that these strategies can buffer performance when sleep debt is expected, especially in military, shift-work, or other high-demand settings.^[raw/articles/pubmed-41892386-sleep-banking-cognitive-motor-impairments-sleep-restriction.md]^[raw/articles/pubmed-40984126-sleep-extension-cognitive-performance-military-aged-adults.md]

...
Cognitive behavioral therapy for insomnia (CBT-I) is the most evidence-based non-drug treatment for chronic insomnia, and that matters for cognition because insomnia is strongly linked to daytime attentional lapses, slower processing speed, and worse executive performance. The best-supported benefit is indirect: when sleep continuity and hyperarousal improve, daytime vigilance and functioning often improve too, even if CBT-I is not a direct nootropic.^[raw/articles/pubmed-36543054-cbt-i-objective-short-sleep-duration.md]

The 2025 JAMA Internal Medicine meta-analysis in chronic disease populations strengthens CBT-I as a sleep-stabilization anchor: 67 RCTs and 5232 participants showed robust improvements in insomnia severity, sleep efficiency, and sleep-onset latency. That is important for this wiki, but it still reads as sleep-outcome evidence rather than direct cognition evidence.^[raw/articles/pubmed-40982264-cbt-i-chronic-disease-meta-analysis.md]
...
For the sequencing question, see [[cbt-i-and-neuromodulation-sequence-effects-on-cognition]], which treats CBT-I as the likely state-stabilizing first step before any enhancement-oriented stimulation protocol.

Anecdotal claims about sharper thinking after fixing insomnia should be kept, but filed through [[anecdotal-evidence-in-cognitive-intervention-research]] and treated as lower-confidence signal rather than proof. For navigation, this page also belongs with [[medicine-cognition-summary]] and [[most-promising-methods-for-cognition]].

...
Elamipretide, also known as SS-31, is a mitochondria-targeting peptide that binds cardiolipin and is now an approved drug under the Forzinity name for Barth syndrome. Its approved use is disease-specific and muscle-strength-focused, not cognition-focused. Within the peptide wiki, that still makes it unusually important: it is one of the few peptide branches with both real regulatory status and a live healthy-aging study that includes cognitive secondary endpoints.^[raw/articles/pubmed-40294492-elamipretide-mitochondrial-mechanism-review.md]^[raw/articles/fda-forzinity-elamipretide-approval.md]^[raw/articles/clinicaltrials-nct07275424-elamipretide-shape.md]

...
|---|---|---|---|---|---|---|
| Adderall-style amphetamine improves focus and mood | `community survey` | raw/articles/darktka-2017-nootropics-survey-on-r-nootropics.md; /r/Nootropics survey mirror | 380 participants / 63 substances; `moderate` | Adderall appears among focus-positive and mood-positive stimulant comparators | low | Survey signal is not d-amphetamine-isomer-specific; diagnosis, sleep debt, dose, access, misuse, and expectancy are major confounds |

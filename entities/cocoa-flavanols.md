...
Anecdote signal: `weak/product-quality focused`. The captured biohacker thread is mostly about high-flavanol content, cost per gram of flavanols, COA / third-party testing, and heavy metal avoidance. That is useful sourcing context but not a direct cognition efficacy corpus.^[raw/articles/reddit-2025-cocoa-flavanol-heavy-metal-product-thread.md]

Safety and product-quality signal: `moderate caution`. A 2024 multi-year analysis of 72 US dark chocolate and cocoa products found lead and cadmium outliers relative to conservative Proposition 65 daily thresholds, while medians were below those thresholds and most products were below FDA lead interim reference levels. This makes cocoa a product-testing problem: routine high-dose cocoa powder or dark chocolate use should not be treated like a clean isolated flavanol exposure.^[raw/articles/frontiers-2024-cocoa-heavy-metals-analysis.md]

## Signal Split

| Layer | Signal | Readout |
|---|---|---|
| Broad flavonoid RCT meta-analysis | `low-moderate` | Small overall cognitive benefit; cocoa subgroup among stronger food-source signals |
| Older-adult short RCTs | `low/product-specific` | CoCoA and diet-quality trials suggest selected executive, processing-speed, or list-learning effects |
| COSMOS clinic | `low/contested` | 500 mg/day cocoa extract for 2 years showed no overall global or domain-specific cognition benefit; possible lower-diet-quality subgroup signal |
...
|---|---|---|---|---|---|---|
| High-flavanol cocoa products are worth sourcing carefully | product-quality anecdote / market salience | raw/articles/reddit-2025-cocoa-flavanol-heavy-metal-product-thread.md; Reddit /r/Biohackers thread | small thread, +7 votes; `weak` | Flavanol content, price per gram, lead/cadmium, COA / third-party testing | low | Product comparison is informal; no direct cognitive outcome denominator |
| Cocoa flavanols improve cognition | research salience, not direct anecdote | raw/articles/pmc-9787524-dietary-flavonoids-human-cognition-meta-analysis.md and controlled-trial raw notes | multiple RCTs but mixed direction; `low-moderate formal`, `weak anecdotal` | Older adults, low diet quality, vascular/metabolic phenotype, hypoxia | low | Formal signal is product- and state-sensitive; chocolate, cocoa powder, extract, and supplements are not interchangeable |
...
- raw/articles/pmc-9787524-dietary-flavonoids-human-cognition-meta-analysis.md
- raw/articles/pmc-4340060-cocoa-flavanol-cocoa-cognition-aging-rct.md
- raw/articles/pubmed-33589674-cocoa-flavanol-diet-cognitive-aging-rct.md
- raw/articles/sciencedirect-2024-cosmos-cocoa-extract-cognition-clinic.md
- raw/articles/pubmed-37315924-cann-dha-cocoa-flavanols-cognition-negative.md
- raw/articles/pubmed-37471213-cocoa-flavanols-hypoxia-cognition-rct.md
- raw/articles/frontiers-2024-cocoa-heavy-metals-analysis.md
- raw/articles/reddit-2025-cocoa-flavanol-heavy-metal-product-thread.md

...
confidence: low
contested: true
contradictions: [senolytic-cognition-2026-scan, negative-evidence-watchlist-for-cognition-interventions]
---

# Dasatinib + Quercetin

Dasatinib plus [[quercetin]] is the main human senolytic-combination cognition branch. It should be treated as a monitored clinical / translational protocol, not as a supplement stack, because dasatinib carries oncology-drug safety burden.

Medicinal cognition signal: `low / open-label and hypothesis-generating`. STAMINA was a 12-week single-arm pilot in older adults at risk for Alzheimer's disease. It reported a mean MoCA increase of 1.0 point overall and 2.0 points in the lowest baseline subgroup, plus an inverse TNF-alpha / MoCA change correlation, but there was no control group and recruitment burden was high.^[raw/articles/pubmed-40010154-senolytics-cognition-mobility-at-risk.md]

The mild-AD phase 1 biomarker paper confirms that CNS exposure to dasatinib is possible and reports exploratory fluid-biomarker movement, but the pattern is mixed and the sample is tiny. It does not provide a robust cognition efficacy estimate.^[raw/articles/pubmed-40274471-dasatinib-quercetin-phase1-mild-alzheimer-biomarkers.md]

Preclinical signal: `supportive but not sufficient`. Aged male rats improved on spatial learning/memory after D+Q, with persistent post-treatment benefit, and nonhuman primates showed inflammaging/metabolic shifts without cognition testing.^[raw/articles/pubmed-35042834-dasatinib-quercetin-aged-rats-cognition.md]^[raw/articles/pubmed-37261678-dasatinib-quercetin-nonhuman-primates-aging-inflammation.md]

...
Medicinal signal: `risk-first/low`. The 2020 review explicitly includes adrafinil as modafinil's prodrug and frames the family through pharmacokinetic, toxicological, clinical, and forensic concerns around unregulated use. That means adrafinil should borrow the wakefulness-comparator logic from [[modafinil]] only with a safety and sourcing downgrade.^[raw/articles/sage-2020-modafinil-adrafinil-review.md]

## Signal Split

| Layer | Signal | Readout |
|---|---|---|
| Formal cognition | `uncataloged` | No current adrafinil-specific cognition trial packet |
| Wakefulness mechanism | `low` by proxy | Prodrug route through modafinil family, not a direct efficacy proof |
| Anecdote | `moderate-strong` | 2017 nootropics survey placed adrafinil among strong focus signals |
| Safety / sourcing | `risk-first` | Gray-market use, prodrug conversion, and monitoring uncertainty dominate |
| Sports / regulatory visibility | `strong caution` | WADA S6.A plus FDA/ORA supplement-screening context put status and product identity ahead of efficacy |
...
Route adrafinil through [[common-nootropic-gray-zone-molecule-watchlist]], [[modafinil]], [[unapproved-modafinil-analog-eugeroic-watchlist]], and [[regulatory-and-sports-visibility-map]]. It should not be ranked beside prescription modafinil unless legal status, athlete/sports visibility, product identity, and liver / drug-interaction monitoring are explicitly handled.
...
- raw/articles/sage-2020-modafinil-adrafinil-review.md
- raw/articles/darktka-2017-nootropics-survey-on-r-nootropics.md
- raw/articles/fda-2024-modafinil-analog-dietary-supplement-lchrms.md
- raw/articles/pubmed-27928893-modafinil-analog-thermal-degradation.md
- raw/articles/wada-2026-stimulant-list-afinils-pemoline-tesofensine.md

...
|---|---|---|
| Mental fatigue | `low` medicinal | Some positive RCTs, but bias/reporting concerns |
| Direct cognition | `weak/unclear` | Better framed as fatigue relief than memory enhancement |
| Community salience | `weak-moderate` anecdote | Appears in older nootropic survey comparisons |
| Safety / product identity | `moderate` caution | Extract standardization and stimulation/anxiety effects matter |

## Anecdote Ledger

| Claim or candidate | Evidence layer | Source and source type | Signal size / strength | Context | Confidence | Caveat |
|---|---|---|---|---|---|---|
| Rhodiola as a nootropic / stress tool | community survey | raw/articles/slatestarcodex-2016-nootropics-survey-results.md; SSC survey summary | 850 respondents overall; `weak-moderate` for Rhodiola in captured summary | Broad nootropic survey; ashwagandha beat rhodiola in one comparison | low | Candidate-specific denominator and effect size are not captured in the wiki summary |
...
- raw/articles/pmc-3541197-rhodiola-rosea-fatigue-systematic-review.md
- raw/articles/slatestarcodex-2016-nootropics-survey-results.md
